          ...
          >
            {status === "checking" && (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-400">{t("checking")}</p>
              </div>
            )}
            ...
            {status === "success" && (
              <div className="text-center py-8">
                ...
                <p className="text-sm font-medium text-green-600 dark:text-green-400 mb-2">{t("success")}</p>
              ...
              <div className="py-8">
                <div className="text-center mb-6">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-red-100 dark:bg-red-900/30 mb-4">
                    <svg className="w-8 h-8 text-red-600 dark:text-red-400" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                      <path d="M6 18L18 6M6 6l12 12" />
                    </svg>
                  </div>
                  <p className="text-sm font-medium text-red-600 dark:text-red-400 mb-2">{message || t("error")}</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    {resendStatus === "loading" ? tCommon("loading") : t("resend")}
                  </button>
                  {resendStatus === "success" && (
                    <p className="text-xs text-green-600 dark:text-green-400 text-center">{t("resendSuccess")}</p>
                  )}
                </div>
